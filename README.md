...
No store needed. Just load the folder.
...
> ⚠️ Firefox temporary add-ons reset when the browser closes.

### 🐧 Linux terminal quick-open

Open the extensions page directly from a terminal:
...
# Firefox — opens the debugging page for temporary add-on loading
...
Без магазину. Просто завантаж папку.
...
1. Відкрий `edge://extensions`
2. Увімкни **Режим розробника** (ліва панель)
3. Натисни **Завантажити розпаковане**
4. Вибери ту ж папку

### Firefox

1. Відкрий `about:debugging`
2. Натисни **This Firefox**
3. Натисни **Завантажити тимчасовий додаток**
4. Вибери `manifest.json` із папки

> ⚠️ Тимчасові додатки Firefox видаляються при закритті браузера.

### 🐧 Термінал (Linux)

Відкрити сторінку розширень прямо з терміналу:
...
# Firefox — сторінка дебагу для тимчасових додатків
firefox about:debugging#/runtime/this-firefox
```
